...
class ProcessTests: XCTestCase {
  ...
  static var allTests : [(String, (ProcessTests) -> () throws -> Void)] {
    return [
      ...
      ("testItExecutesACommanAndHandlesErrorsdWithDummyExecutor", testItExecutesACommanAndHandlesErrorsdWithDummyExecutor),
      ("testItEchosBackStdoutAndStderr", testItEchosBackStdoutAndStderr),
      ("testItDoesNotEchoIfEmpty", testItDoesNotEchoIfEmpty),
      ("testICanEchoOnlyTheCommand", testICanEchoOnlyTheCommand),
      ("testItEchosStdoOutOnly", testItEchosStdoOutOnly),
      ("testItEchosStderrtOnly", testItEchosStderrtOnly),
      ("testItCanEchoBackNothing", testItCanEchoBackNothing),
      ("testItCanEchoBackTheCommandOnly", testItCanEchoBackTheCommandOnly),
      ("testItExecuteLS", testItExecuteLS),
      ("testItDryExecutesLS", testItDryExecutesLS)
    ]
  }
}
